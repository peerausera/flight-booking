...
urlpatterns = [
    ...
    path('ListAllCustomer',views.ListAllCustomer),
    path('ListAllCustomer/get', views.getCustomer),
    path('ListAllCustomer/get/<username>', views.CustomerGet.as_view(), name='customer_get'), 
    path('ListAllCustomer/list',views.CustomerList.as_view(), name='customer_list'),
    path('ListAllCustomer/delete', views.CustomerDelete.as_view(), name='customer_delete'),
    path('ListAllTicket',views.ListAllTicket),
    path('ListAllTicket/get', views.getTicket),
    path('ListAllTicket/get/<ticket_id>', views.TicketGet.as_view(), name='ticket_get'), 
    path('ListAllTicket/list',views.TicketList.as_view(), name='ticket_list'),
    path('ListAllTicket/delete', views.TicketDelete.as_view(), name='ticket_delete'),    
    path('ReportListAllFlight',views.ReportListAllFlight),
    path('FlightManagement', views.FMindex, name='FMindex'),
    # path('FlightManagement/save/', views.Flightsave.as_view(), name='Flightsave'),
